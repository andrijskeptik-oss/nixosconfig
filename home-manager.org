* конфигурация delux
## ~/Linux/nixosconfig/delux-nix/home.nix :mkdirp yes :noweb yes
#+name: delux
...
** cortile
*** Файл конфигурации 
#+header: :tangle  .~/config/cortile/config.toml :mkdirp yes
#+begin_src toml
       ################################################################################
       #                                                                              #
...
#+end_src
** clifm
,#+header: :tangle ~/.config/clifm/profiles/default/preview.clifm  :mkdirp yes
#+begin_src txt
                  ############################################
...
#+header: :tangle  ~/.config/ranger/rifle.conf :mkdirp yes  
#+begin_src text 
# vim: ft=cfg
#
...
#+header:  :tangle  ~/.config/ranger/scope.sh :mkdirp yes :tangle-mode "a+x"
#+begin_src bash
   #!/usr/bin/env bash
