...
'cmd-set-text -s :open -t {clipboard}' : ['<Ctrl-X><Ctrl-W><Ctrl-X>'],
'cmd-set-text -s :open -t {primary}' : ['<Ctrl-X><Alt-W><Ctrl-X>'],
'cmd-set-text -s :open  {clipboard}' : ['<Ctrl-X><Ctrl-W><Ctrl-F>'],
'cmd-set-text -s :open  {primary}' : ['<Ctrl-X><Alt-W><Ctrl-F>'],
}
#+end_src
***** Хинты+
#+begin_src python :noweb-ref qutebrowser-config
  d_hints={
  'hint images window' : ['<Ctrl-X>5<Ctrl-C><Ctrl-I>'],
  'hint images' : ['<Ctrl-C><Ctrl-I>'],
  'hint links fill :open -t -r {hint-url}' : ['<Ctrl-C><Ctrl-X>'],
  'hint links fill :open {hint-url}' : ['<Ctrl-C><Ctrl-F>'],
  'hint links yank' : ['<Ctrl-C><Ctrl-W>'],
  'hint links yank-primary' :['<Ctrl-C><Alt-W>'],
  'hint all tab-bg' : ['<Ctrl-C><Ctrl-T>'],
  'hint links download' : ['<Ctrl-C><Ctrl-D>'],
  'hint all window' : ['<Ctrl-X>5<Ctrl-C>'],
  'hint all tab-fg' : ['<Ctrl-U><Ctrl-C><Ctrl-T>'],
  'hint --rapid links tab-bg' : ['<Ctrl-C><Ctrl-M>'],
  'hint all hover' : ['<Ctrl-C><Ctrl-H>'],
  'hint inputs' : ['<Ctrl-C><Ctrl-R>'],
  'hint' : ['<Ctrl-C><Ctrl-C>'],
  'hint inputs --first' : ['<Ctrl-U><Ctrl-C><Ctrl-R>'],
   }
#+end_src
***** Вкладки+
#+begin_src python :noweb-ref qutebrowser-config
d_tabs={
'tab-next' : ['<Ctrl-T><Ctrl-Right>','<Ctrl-T><Right>'],
'tab-prev' : ['<Ctrl-T><Ctrl-Left>','<Ctrl-T><Left>'],
'tab-focus last' : ['<Ctrl-T><Backspace>'],
'tab-pin' : ['<Ctrl-T><Ctrl-P>'],
'tab-close' : ['<Pause>','<Ctrl-X><Ctrl-K>'],
'cmd-set-text -sr :tab-focus' : ['<Ctrl-T><Ctrl-T>'],
'tab-only' : ['<Ctrl-T><Ctrl-X>1'],
'tab-clone' : ['<Ctrl-T><Ctrl-C>'],
'tab-give -p' : ['<Ctrl-X>5<Ctrl-T>'],
'cmd-set-text -s :tab-take' : ['<Ctrl-U><Ctrl-X>5<Ctrl-T>'],

'tab-move +' : ['<Ctrl-T><Ctrl-PgUp>','<Ctrl-T><PgUp>'],
'tab-move -' : ['<Ctrl-T><Ctrl-PgDown>','<Ctrl-T><PgDown>'],
'tab-mute' : ['<Ctrl-T><Ctrl-M>'],
}
#+end_src
***** Окна+
#+begin_src python :noweb-ref qutebrowser-config
d_windows={
'open -w' : ['<Ctrl-X>5<Ctrl-X>'],
}
#+end_src
***** Закладки+
#+begin_src python :noweb-ref qutebrowser-config
d_bookmarks={
#'home' : ['~'],
'cmd-set-text -s :quickmark-load -t' : ['<Ctrl-X><Ctrl-Q>'],
'cmd-set-text -s :bookmark-load -t' : ['<Ctrl-X>rb','<Ctrl-X>ки','<Ctrl-X><Ctrl-B>'],
'quickmark-save' : ['<Ctrl-X>rM','<Ctrl-X>кЬ'],
'bookmark-add' : ['<Ctrl-X>rm','<Ctrl-X>кь'],
'bookmark-list -t' : ['<Ctrl-X>rl','<Ctrl-X>кд','<Ctrl-X><Ctrl-L>'],
}
#+end_src
...
#+begin_src python :noweb-ref qutebrowser-config
d_history={
'navigate decrement' : ['<Ctrl-N>+'],
'navigate increment' : ['<Ctrl-N>-'],
'back' : ['<Alt-P>'],
'forward' : ['<Alt-N>'],
'navigate prev' : ['<Ctrl-N>P'],
'navigate next' : ['<Ctrl-N>N'],
'navigate prev -t' : ['<Ctrl-N><Ctrl-T>P'],
'navigate next -t' : ['<Ctrl-N><Ctrl-T>P'],
'history -t' : ['<Alt-h>'],
'navigate up' : ['<Ctrl-N><Ctrl-<Up>','<Ctrl-N><Up>'],
'back -w' : ['<Ctrl-X>5<Alt-P>'],
'scroll-to-perc 0' : ['<Alt-,>'],
'navigate up -w' : ['<Ctrl-X>5<Ctrl-N><Ctrl-<Up>','<Ctrl-X>5<Ctrl-N><Up>'],
'forward -w' : ['<Ctrl-X>5<Alt-N>'],
'scroll-to-perc' : ['<Alt-.>'],
}
#+end_src
***** Изменение масштаба+
...
#+begin_src python :noweb-ref qutebrowser-config
d_clipboard={
'yank domain' : ['<Ctrl-W><Ctrl-D>'],
'yank domain -s' : ['<Alt-W><Alt-D>'],
'yank inline [{title}]({url})' : ['<Ctrl-W><Ctrl-M>'],
'yank inline [{title}]({url}) -s' : ['<Alt-W><Alt-M>'],
'yank inline [[{url}][{title}]]' : ['<Ctrl-W><Ctrl-O>'],
'yank inline [[{url}][{title}]] -s' : ['<Alt-W><Alt-O>'],
'yank pretty-url' : ['<Ctrl-W><Ctrl-P>'],
'yank pretty-url -s' : ['<Alt-W><Alt-P>'],
'yank title' : ['<Ctrl-W><Ctrl-T>'],
'yank title -s' : ['<Alt-W><Alt-T>'],
'yank' : ['<Ctrl-W><Ctrl-W>'],
'yank -s' : ['<Alt-W><Alt-W>'],
}
#+end_src
...
#+begin_src python :noweb-ref qutebrowser-config
d_download={
'download-cancel' : ['<Ctrl-D><Ctrl-G>'],
'download-delete' : ['<Ctrl-D><Ctrl-K>'],
'download-clear' : ['<Ctrl-D><Ctrl-C>'],
'download' : ['<Ctrl-D><Ctrl-D>'],
'download-open' : ['<Ctrl-D><Ctrl-O>'],
}
#+end_src
...
'mode-leave' : ['<Escape>','<Ctrl-G>'],
'yank selection' : ['<Ctrl-W>'],
...
'yank selection -s' : ['<Alt-W>'],
'move-to-start-of-prev-block' : ['<Alt-A>'],
'move-to-start-of-next-block' : ['<Alt-E>'],
'move-to-prev-word' : ['<Alt-B>'],
'mode-enter normal' : ['<Ctrl-G>'],
'move-to-start-of-document' : ['<Alt-,>'],
'move-to-prev-char' : ['<Left>','<Ctrl-B>'],
'move-to-next-line' : ['<Down>','<Ctrl-N>'],
'move-to-prev-line' : ['<Up>','<Ctrl-P>'],
'move-to-next-char' : ['<Right>','<Ctrl-F>'],
'selection-reverse' : ['<Ctrl-X><Ctrl-X>'],
...
'cmd-set-text -a {url}' : ['<Ctrl-Y><Ctrl-U>'], 
'cmd-set-text -a {url:pretty}' : ['<Ctrl-Y><Ctrl-P'], 
'cmd-set-text -a {url:host}' : ['<Ctrl-Y><Ctrl-H>'], 
'cmd-set-text -a {url:domain}' : ['<Ctrl-Y><Ctrl-D>'], 
'cmd-set-text -a {url:query}' : ['<Ctrl-Y><Ctrl-Q>'], 
'cmd-set-text -a {url:port}' : ['<Ctrl-Y><Alt-P>'], 
'cmd-set-text -a {title}' : ['<Ctrl-Y><Ctrl+T>'], 
'cmd-set-text -a {clipboard}' : ['<Ctrl-Y><Ctrl-Y>'], 
'cmd-set-text -a {primary}' : ['<Alt-Y><Alt-Y>'], 
}
#+end_src
***** Клавиши режима хинтов+
#+begin_src python :noweb-ref qutebrowser-config
d_hint_mode={
#'hint all tab-bg' : ['<Ctrl-T>'],
#'hint links' : ['<Ctrl-L>'],
'hint --rapid links tab-bg' : ['<Ctrl-M>'],
'mode-leave' : ['<Escape>','Ctrl-G'],
'hint-follow' : ['<Return>'],
}
#+end_src
...
#+begin_src python :noweb-ref qutebrowser-config
d_spawn={
'cmd-set-text -s :spawn' : ['<Alt-Shift-!><Alt-Shift-!>'],
'spawn kitty' : ['<Alt-Shift-!><Alt-T>'],
'magnet' : ['<Alt-Shift-!><Alt-M>'],
'cmd-set-text -s :spawn yt-dlp  {clipboard}' : ['<Alt-Shift-!><Alt-Y>'],
'spawn firefox {url}' : ['<Alt-Shift-!><Alt-F>'],
'cmd-set-text -s :spawn -u chataiorg "{url:host}" "{title}"' : ['<Alt-Shift-!><Alt-A>'],
'cmd-set-text -s :spawn -u cachetoorg "{title}"' : ['<Alt-Shift-!><Ctrl-P>'],
'cmd-set-text -s :spawn pandoc --wrap=none --extract-media="/home/andrey/Загрузки/{title}" -o "/home/andrey/Загрузки/{title}.org" {url}' : ['<Alt-Shift-!><Alt-P>'],
}
...
telegramz https://web.telegram.org/a/#-1153786240
...
fadar https://www.faganfinder.com/
...
blogger https://draft.blogger.com/blog/posts/1207372942119176135
imageerase https://huggingface.co/spaces/finegrain/finegrain-object-eraser
imagebackground https://huggingface.co/spaces/innova-ai/video-background-removal
libgen https://libgen.is/
rutrackernet https://rutracker.net
rutrackerorg https://rutracker.net
whisher large https://huggingface.co/spaces/hf-audio/whisper-large-v3-turbo
whisher jax https://huggingface.co/spaces/sanchit-gandhi/whisper-jax#:~:text=whisper-jax.%20like%202.25k.%20Running%20App%20Files%20Files%20Community%20126%20Refreshing.
matecat https://www.matecat.com/
gemimy https://gemini.google.com/app/937aa3ab7add86b6?hl=en-IN
translaror1 https://quillbot.com/translate?_x_tr_hist=true
translator2 reverso https://www.reverso.net/text-translation
translator3 mashine translate https://www.machinetranslation.com/
#+end_src
*** bookmarks
...
ttps://products.wolframalpha.com/api Wolfram|Alpha APIs: Computational Knowledge Integration 
...
** cortile
*** Файл конфигурации 
#+begin_src toml :tangle ~/.config/cortile/cortile.toml :mkdirp yes
       ################################################################################
       #                                                                              #
...
#+end_src
** kitty
#+header: :noweb-ref :tangle ~/.config/kitty/kitty.conf :mkdirp yes
#+begin_src conf
...
#!/usr/bin/env bash
sudo bash <<END
mount LABEL=vingo /mntsys || exit 1
...
rsync -av --delete /home/andrey/Data/ /mnt/Data/
rsync -av --delete /home/andrey/iso/ /mnt/iso/
rsync -av --delete /home/andrey/Музыка/ /mnt/Music/
#rsync -av --delete /mnts/nixhome/ /mnt/nixhome/
rsync -av --delete /home/andrey/Изображения/ /mnt/Pictures/
rsync -av --delete /home/andrey/Видео/ /mnt/Videos/
rsync -av --delete /home/andrey/Calibre/ /mnt/Calibre/
umount /mnt
umount /mntsys
END
#+end_src
